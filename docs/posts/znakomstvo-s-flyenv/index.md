...
В стандартной бесплатной версии можно создать 3 сайта, пользоваться ИИ-помощником (Ollama, с загрузкой моделей) и наслаждаться большим количеством доступных модулей из коробки.

В платной ко всему этому добавляется синхронизация нескольких устройств, снятие запрета на количество сайтов, встроенный почтовый сервер и некоторые другие плюшки.
