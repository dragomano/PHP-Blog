...
Обе админки используют иконки Heroicons. Но в нашем проекте используется коллекция Font Awesome. И в некоторых ресурсах должен быть выбор иконок при создании/редактировании:
...
И, наконец, куда же без социальных ссылок? Давайте добавим:
...
- Не все настройки можно задать через `MoonShineServiceProvider`, иногда приходится использовать и файл `moonshine.php`.
