...
- Запускаем консоль, нажимаем на крайнюю правую иконку и выбираем пункт «Настройки...» («Settings...»).
...
- Обновляем `npm` с помощью команды `npm install -g npm` в консоли.
- Если нужно обновить сам Node.js — просто скачиваем и устанавливаем свежую версию установщика.
